...
public abstract class HarmDocumentsProvider extends DocumentsProvider
{
    ...
    public Cursor queryRoots(String[] projection) {
        ...
        int flags = Root.FLAG_SUPPORTS_CREATE | Root.FLAG_SUPPORTS_SEARCH;
    ...
    public Cursor querySearchDocuments(String rootId, String query, String[] projection) throws FileNotFoundException {
        ...
        while (!pending.isEmpty() && result.getCount() < MAX_SEARCH_RESULTS) {
            ...
            try {
                isInsideHome = file.getCanonicalPath().startsWith(GetPath());
            } catch (IOException e) {
                isInsideHome = true;
            }
            if (isInsideHome) {
